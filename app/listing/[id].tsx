      ...
      headerRight: () => (
        <View style={styles.bar}>
          <TouchableOpacity
            ...
            onPress={() => sharedListing()}
          >
            <Ionicons name="share-outline" size={22} color={"#000"}></Ionicons>
          </TouchableOpacity>
          <TouchableOpacity style={styles.roundButton}>
            <Ionicons name="heart-outline" size={22} color={"#000"}></Ionicons>
          </TouchableOpacity>
        </View>
      ),
      headerLeft: () => (
        <TouchableOpacity
          ...
          onPress={() => router.back()}
        >
          <Ionicons name="chevron-back" size={22} color={"#000"}></Ionicons>
        </TouchableOpacity>
      ),
    });
  }, []);
